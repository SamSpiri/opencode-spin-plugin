#!/usr/bin/env node
/**
 * Install spin.js plugin + Spin, spin-rnd, spin-ops and Pall skills into
 * opencode's default directories so they're auto-discovered (no opencode.json
 * plugin entry needed).
 *
...
async function main() {
  ...
  for (const name of ["spin", "spin-rnd", "spin-ops"]) {
